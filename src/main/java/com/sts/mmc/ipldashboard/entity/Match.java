...
public class Match {
	...
	public String toString() {
		return "MatchDataDTO [city=" + city + ", date=" + date + ", id=" + id + ", matchWinner=" + matchWinner
				+ ", neutralVenue="  + ", playerOfMatch=" + playerOfMatch + ", result=" + result
