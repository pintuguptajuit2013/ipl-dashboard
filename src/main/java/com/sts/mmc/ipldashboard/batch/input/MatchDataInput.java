package com.sts.mmc.ipldashboard.batch.input;

/**
 * Match Data Input Bean Class
 * 
 * @author pStringug
 *
 */
public class MatchDataInput {
	...
	private String toss_winning_team;
	...
	public String getToss_winning_team() {
		return toss_winning_team;
	}
	public void setToss_winning_team(String toss_winning_team) {
	...
	public MatchDataInput() {
		super();
		// TODO Auto-generated constructor stub
	}
	public MatchDataInput(String id, String city, String date, String player_of_match, String venue,
			String neutral_venue, String team1, String team2, String toss_winning_team, String toss_decision, String winner,
	...
	public String toString() {
		return "MatchDataInput [id=" + id + ", city=" + city + ", date=" + date + ", player_of_match=" + player_of_match
				+ ", venue=" + venue + ", neutral_venue=" + neutral_venue + ", team1=" + team1 + ", team2=" + team2
				+ ", toss_winner=" + toss_winning_team + ", toss_decision=" + toss_decision + ", winner=" + winner
