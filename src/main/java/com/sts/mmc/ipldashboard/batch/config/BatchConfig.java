package com.sts.mmc.ipldashboard.batch.config;
...
import com.sts.mmc.ipldashboard.batch.listener.MatchJobCompletionNotificationListener;
import com.sts.mmc.ipldashboard.batch.processor.MatchDataItemProcessor;
...
public class BatchConfig {
	...
	private final String[] FIELD_NAMES = new String[] { "id", "city", "date", "player_of_match", "venue","neutral_venue", "team1",
			"team2", "toss_winning_team", "toss_decision", "winner", "result", "result_margin", "eliminator","method","umpire1", "umpire2" };
	...
	public FlatFileItemReader<MatchDataInput> reader() {
		return new FlatFileItemReaderBuilder<MatchDataInput>().name("matchItemReader")
				.resource(new ClassPathResource("IPLMatches.csv")).delimited()
	...
	@Bean
	public Job importUserJob(MatchJobCompletionNotificationListener listener, Step step1) {
